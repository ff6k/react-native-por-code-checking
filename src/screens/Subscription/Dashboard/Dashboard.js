    ...
    const Done = ({ isLight, ...props }) => (
        <View
            ...
            <StyledOpacityButton
                ...
                onPress={() =>
                    navigation.navigate(Routes.SUBSCRIPTIONSELECTSUBSCRIPTION)
                }
            />
        </View>
    );
            ...
            pages={[
                {
                    ...
                    image: <Image source={indianVictorImg} style={{}} />,
                ...
                },
                {
                    ...
                    image: <Image source={manAndGirlVictorImg} />,
                    title: 'Como funciona 2',
                    subtitle:
                        'Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing.',
                },
                {
                    backgroundColor: theme.main.colors.pink,
                    image: <Image source={capGirlVictorImg} />,
                    title: 'Como funciona 3',
                    subtitle:
                        'Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing.',
                },
            ]}
